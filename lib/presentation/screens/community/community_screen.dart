      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8.h),
            Text('Be the first to share!', style: AppTextStyles.bodyMedium),
          ],
        ),
      );
    }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Row(
              children: [
                Text('Create Post', style: AppTextStyles.h3),
                const Spacer(),
                IconButton(
                  ...
                  if (_isLoading)
                    ...
                    Center(
                      child: Padding(
                        ...
                        child: Text('No comments yet', style: AppTextStyles.bodyMedium),
                      ),
                    )
                  else
