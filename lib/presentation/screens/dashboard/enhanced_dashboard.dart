              ...
              Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Current Weather', style: AppTextStyles.h3),
                      SizedBox(height: 8.h),
                      Row(
                        children: [
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12.h),
            _UpcomingTaskItem('Harvest Field B', 'Tomorrow, 6:00 AM'),
            _UpcomingTaskItem('Pest Inspection', 'Dec 3, 9:00 AM'),
            _UpcomingTaskItem('Soil Testing', 'Dec 5, 10:00 AM'),
          ],
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
        padding: EdgeInsets.all(16.w),
        children: [
          Text('My Fields', style: AppTextStyles.h2),
          SizedBox(height: 16.h),
          _FieldCard('Field A - Wheat', '2.5 acres', 'Loamy Soil', Icons.grass),
          _FieldCard('Field B - Rice', '3.0 acres', 'Clay Soil', Icons.rice_bowl),
          _FieldCard('Field C - Vegetables', '1.5 acres', 'Sandy Soil', Icons.yard),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(
        padding: EdgeInsets.all(16.w),
        children: [
          Text('Community', style: AppTextStyles.h2),
          SizedBox(height: 16.h),
          _PostCard(
            'Rajesh Kumar',
            '2 hours ago',
        ...
        Center(
          child: Column(
            children: [
              ...
              Text('+91 98765 43210', style: AppTextStyles.bodyLarge),
            ],
          ),
        ),
