        ...
        builder: (context, scrollController) => Container(
          ...
          child: ListView(
            ...
            children: [
              ...
              _buildDetailRow(Icons.straighten, 'Area', '${field.area} acres'),
              if (field.cropType != null)
                _buildDetailRow(Icons.grass, 'Crop Type', field.cropType!),
              if (field.soilType != null)
                _buildDetailRow(Icons.terrain, 'Soil Type', field.soilType!),
              _buildDetailRow(
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16.h),
            Text('No fields added yet', style: AppTextStyles.h3),
            SizedBox(height: 8.h),
            Text('Tap + to add your first field', style: AppTextStyles.bodyMedium),
          ],
        ),
      );
    }
            ...
            children: [
              Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.landscape, color: AppColors.primary, size: 24.sp),
                  ),
                  SizedBox(width: 12.w),
                  Expanded(
                    child: Column(
              ...
              if (field.cropType != null || field.soilType != null) ...[
                ...
                Wrap(
                  ...
                  children: [
                    if (field.cropType != null)
                      _buildChip(Icons.grass, field.cropType!, AppColors.success),
                    if (field.soilType != null)
                      _buildChip(Icons.terrain, field.soilType!, AppColors.secondary),
                  ],
                ),
              ],
              SizedBox(height: 8.h),
